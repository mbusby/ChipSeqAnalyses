clear
close all
directory='C:\Data\ChipSeqPaper\Data\DownsampledByInsertSize\BamIntersectedWith2000Bp\'
...
for i=1:length(sampleNames)
    ...
    [ ~, ~, ~, overlappingReads, ~, ~ ] = ReadBedtoolsCoverage( fileName);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    print('C:\Data\ChipSeqPaper\Figures\scatterH3K27ac','-dpng','-r350')
...
xt = get(gca, 'YTick');
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\scatterH3K27me3','-dpng','-r350')
...
'mAb-K36me3-1.dupsRemoved.bam.bam.txt'
'mAb-K36me3-2.dupsRemoved.bam.bam.txt'
'pAb-K36me3-1.dupsRemoved.bam.bam.txt'
'pAb-K36me3-2.dupsRemoved.bam.bam.txt'
};
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\scatterH336me3','-dpng','-r350')
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\scatterH3K4me1.pdf','-dpng','-r350')
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\scatterH3K4me3.pdf','-dpng','-r350')
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\scatterH3K9me3.pdf','-dpng','-r350')
...
for i=1:length(sampleNames)
    ...
    fileName=strcat(directory, sampleNames{i});
    [ ~, ~, ~, overlappingReads, ~, ~, annotationType ] = ReadBedtoolsCoverage( fileName );
    data(:,i)=overlappingReads;
