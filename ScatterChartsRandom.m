...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    print('C:\Data\ChipSeqPaper\Figures\random_scatterH3K27ac','-dpdf','-r350')
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\random_scatterH3K27me3','-dpdf','-r350')
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\random_scatterH336me3','-dpdf','-r350')
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\random_scatterH3K4me1.pdf','-dpdf','-r350')
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\random_scatterH3K4me3.pdf','-dpdf','-r350')
...
set(gca, 'FontSize', 9)
    ...
    fig.PaperPositionMode = 'manual';
    fig.PaperOrientation = 'landscape';
    print('C:\Data\ChipSeqPaper\Figures\random_scatterH3K9me3.pdf','-dpdf','-r350')
