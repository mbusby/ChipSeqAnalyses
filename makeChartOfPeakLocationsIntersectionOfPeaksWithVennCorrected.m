clear
    dirName ='C:\Data\ChipSeqPaper\Data\MergedPeaks\NewIntersection'
...
fileNames={
    'K27acMonoPolyVsEncode.bed'
'K27acMonoVsEncode.bed'
'K27acPolyVsEncode.bed'
'K4me1MonoPolyVsEncode.bed'
'K4me1MonoVsEncode.bed'
'K4me1PolyVsEncode.bed'
'K4me3MonoPolyVsEncode.bed'
'K4me3MonoVsEncode.bed'
'K4me3PolyVsEncode.bed'
...
for i=1:length(fileNames)
     ...
     for j=1:length(annTypes)
         overlappingOriginal(ctrVals,j)=sum(overlappingBases(strcmp(featureType, annTypes{j})));
         overlappingPercOriginal(ctrVals,j)=sum(overlappingBases(strcmp(featureType, annTypes{j})))/total;
     end
...
for i=1:3:size(overlappingOriginal, 1)
   overlapping(i,:)=overlappingOriginal(i,:);
   overlapping(i+1,:)=overlappingOriginal(i+1,:)-overlappingOriginal(i,:);
   overlapping(i+2,:)=overlappingOriginal(i+2,:)-overlappingOriginal(i,:);
end

for i=1:size(overlapping,1)
 overlappingPerc(i,:)=overlapping(i,:)./sum(overlapping(i,:),2)
end
